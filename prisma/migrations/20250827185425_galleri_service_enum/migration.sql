/*
  ...
  - The values [galleri] on the enum `TargetType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "TargetType_new" AS ENUM ('profile', 'service', 'article', 'galleri_service');
