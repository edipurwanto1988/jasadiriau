...
// --- Icons ---
import { AlignCenterIcon } from "@/views/components/tiptap-icons/align-center-icon"
import { AlignJustifyIcon } from "@/views/components/tiptap-icons/align-justify-icon"
import { AlignLeftIcon } from "@/views/components/tiptap-icons/align-left-icon"
import { AlignRightIcon } from "@/views/components/tiptap-icons/align-right-icon"
