...
// --- Icons ---
import { BoldIcon } from "@/views/components/tiptap-icons/bold-icon"
import { Code2Icon } from "@/views/components/tiptap-icons/code2-icon"
import { ItalicIcon } from "@/views/components/tiptap-icons/italic-icon"
import { StrikeIcon } from "@/views/components/tiptap-icons/strike-icon"
import { SubscriptIcon } from "@/views/components/tiptap-icons/subscript-icon"
import { SuperscriptIcon } from "@/views/components/tiptap-icons/superscript-icon"
import { UnderlineIcon } from "@/views/components/tiptap-icons/underline-icon"
