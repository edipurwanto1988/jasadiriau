...
import { createAccountBusinessProfileSchema, updateAccountBusinessProfileSchema } from "@/schema/business-profile.schema";
...
const AccountUpdateBusiness = () => {
  ...
  const validation = useZod({
    data: mutation.data(),
    schema: updateAccountBusinessProfileSchema,
  });
  ...
  const onSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (validated) {
      mutation.send({
        ...
        onSuccess: (resp) => {
          openSnackbar("Profil bisnis Anda sudah berhasil diperbaharui.");
  ...
  return (
    <PageTemplate title="Ubah Bisnis Profil" onBack={() => router.back()}>
...
export default AccountUpdateBusiness;
